...
## Trạng thái hiện tại — V2.5 persistent arrange mode + auto layout
...
- PWA/offline với Service Worker cache v15; lần cài đầu precache cả tài nguyên JS/CSS liên kết từ bản build để offline đáng tin cậy hơn.
...
- DOM integration tests cho boot app, product editing, template switching, history, reset, print preflight, dữ liệu local sai kiểu, accessibility trạng thái tab, rollback restore khi giả lập hết dung lượng, kéo trường trên preview, resize/reset logo, kéo liên tiếp trong cùng phiên sắp xếp và tự động sắp xếp;
