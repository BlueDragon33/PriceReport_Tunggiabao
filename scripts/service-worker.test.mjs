...
assert.equal(activeCache, 'pricereport-shell-v63-unified-content-workspaces', 'V6.3 unified-content-workspace release must rotate the application shell cache');
