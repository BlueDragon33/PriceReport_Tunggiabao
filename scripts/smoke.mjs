...
if (!sw.includes("pricereport-shell-v615-standalone-contract-cleanup")) fail('Service-worker cache version was not aligned with the V6.14 standalone access release');
...
if ((html.match(/data-template-library-theme=/g) || []).length < 16) fail('V6.2 template library must expose all 16 quotation themes');
